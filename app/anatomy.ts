...
export const SYSTEMS: {id:SystemId;name:string;color:string;description:string}[] = [
 ...
 {id:'fascia',name:'Fascia',color:'#7cb8af',description:'Named fasciae curated from verified source meshes. No independent named fascia is currently verified in this atlas snapshot.'},
 {id:'fascial-system',name:'Fascial system',color:'#7caaa6',description:'A broader display category containing the source iliotibial tracts and wrist flexor retinacula. These four pieces are not a complete model of named fasciae or of the fascial system.'},
...
export interface SceneState {fasciaOpacity:number;fascialSystemOpacity:number;inspectorOpen?:boolean;explode:number;visible:SystemId[];selected:string[];isolate:boolean;view:View;rotate:boolean;reset:number}
